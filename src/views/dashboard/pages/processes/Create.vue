        ...
        <base-material-card icon="mdi mdi-cog" color="primary">
          <template v-slot:after-heading>
            <div class="font-weight-light card-title mt-2">
              Procesos
              <span class="body-1">— Registro de Procesos</span>
            </div>
          </template>
...
export default {
  data() {
    return {
      ...
      inputs: {
        ...
        tipo: '',
        categoria: '',
        proyecto: this.$route.params.id_project,
        estado:'A'
      },
    }
  },
  ...
  created() {
    this.proyecto = this.$route.params.id
  },
  computed: {},
  methods: {
    ...mapActions('processes', ['createProcess']),
  },
}
</script>
